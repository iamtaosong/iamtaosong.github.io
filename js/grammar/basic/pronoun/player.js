...
function testNextBtnFunction() {
  ...
  if(common.game=="wordImageMatch")
  {
    if(wordImageMatchObj.counter<(learnObj.totalLenght-1))
    {
      ...
      if(wordImageMatchObj.counter>=wordImageMatchObj.sectionLength)
      {
        wordImageMatchObj.list0[4].value=learnObj.letterList[wordImageMatchObj.counter].word;
        wordImageMatchObj.list1[4].innerText=learnObj.letterList[wordImageMatchObj.counter].word;
      }
    }
  ...
  }else if (common.game=="wordSoundMatch")
  {
    ...
    if(wordSoundMatchObj.counter<(learnObj.totalLenght-1))
    {
      ...
      if(wordSoundMatchObj.counter>=wordSoundMatchObj.sectionLength)
      {
        wordSoundMatchObj.list0[4].value=learnObj.letterList[wordSoundMatchObj.counter].word;
        wordSoundMatchObj.list1[4].innerText=learnObj.letterList[wordSoundMatchObj.counter].word;
      }
...
function testPreviousBtnFunction() {
  ...
  if(common.game=="wordImageMatch")
  {
    ...
    {
      wordImageMatchObj.counter--;
      if(wordImageMatchObj.counter>=wordImageMatchObj.sectionLength || wordImageMatchObj.counter==wordImageMatchObj.sectionLength-1)
      {
        wordImageMatchObj.list0[4].value=learnObj.letterList[wordImageMatchObj.counter].word;
        wordImageMatchObj.list1[4].innerText=learnObj.letterList[wordImageMatchObj.counter].word;
      }
  ...
  }else if (common.game=="wordSoundMatch")
  {
    ...
    {
      wordSoundMatchObj.counter--;
      if(wordSoundMatchObj.counter>=wordSoundMatchObj.sectionLength || wordSoundMatchObj.counter==wordSoundMatchObj.sectionLength-1)
      {
        wordSoundMatchObj.list0[4].value=learnObj.letterList[wordSoundMatchObj.counter].word;
        wordSoundMatchObj.list1[4].innerText=learnObj.letterList[wordSoundMatchObj.counter].word;
      }
