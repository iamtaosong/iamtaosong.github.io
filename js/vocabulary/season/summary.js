...
document.getElementById("video1").addEventListener("click",function(){
  ...
  document.getElementById('videoLink').src ="https://www.youtube.com/embed/C_Sc5ZjdfFI?si=WqgYzdQYwXwVar6e";
  
});

document.getElementById("video2").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/Ut3BFedwvW8?si=rYFbVpE40MLgMPJt";
  
});

document.getElementById("video3").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/_6cG913j6kc?si=JUoeVIdCpdWixVc6";
