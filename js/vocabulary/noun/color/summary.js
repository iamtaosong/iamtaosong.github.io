...
function buildWordImageMatch()
{
  ...
  wordImageMatchObj.picture.setAttribute("style",learnObj.letterList[0].setting);
...
document.getElementById("video0").addEventListener("click",function(){
  ...
  document.getElementById('videoLink').src ="https://www.youtube.com/embed/zxIpA5nF_LY?si=86xmrirHUQ4dADbI";  
});

document.getElementById("video1").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/tkpfg-1FJLU?si=wIA003JeNC3nAp8M";
  
});

document.getElementById("video2").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/pUPM3DtK9so?si=lCRFh_CmpzxpCH7S";
  
});

document.getElementById("video3").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/7_Zzw96qJ1Y?si=v_cgfeFvhri36I0Y";
