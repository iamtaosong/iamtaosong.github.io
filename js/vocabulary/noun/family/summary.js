...
document.getElementById("video0").addEventListener("click",function(){
  ...
  document.getElementById('videoLink').src ="https://www.youtube.com/embed/G6k7dChBaJ8?si=GHmVC4JtAAvGVfKW";
  
});

document.getElementById("video1").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/d_WQEw13TCo?si=e7_hD_KPlCUoMjv4";
  
});

document.getElementById("video2").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/_z5xcqEjSes?si=vFbDaxCs7zu20bUO";
  
});

document.getElementById("video3").addEventListener("click",function(){

  document.getElementById('videoLink').src ="https://www.youtube.com/embed/Kjl5sPWcD-o?si=XKnVdgbb8DTOXcfe";
